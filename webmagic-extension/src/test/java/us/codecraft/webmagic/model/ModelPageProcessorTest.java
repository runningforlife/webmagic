...
public class ModelPageProcessorTest {
    ...
    public void testMultiModel_should_not_skip_when_match() throws Exception {
        ...
        page.setRequest(new DownloadRequest("http://codecraft.us/foo"));
    ...
    public void testExtractLinks() throws Exception {
        ...
        modelPageProcessor.process(page);
        assertThat(page.getTargetRequests()).containsExactly(new DownloadRequest("http://webmagic.io/list/1"), new DownloadRequest("http://webmagic.io/list/2"), new DownloadRequest("http://webmagic.io/post/1"), new DownloadRequest("http://webmagic.io/post/2"));
    ...
    private Page getMockPage() throws IOException {
        ...
        page.setRequest(new DownloadRequest("http://webmagic.io/list/0"));
